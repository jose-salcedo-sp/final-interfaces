...
export default function Career() {
                        ...
                        if (foundUser) {
                            ...
                            setUser({
                                ...
                                studies: {
                                    ...
                                    courses:
                                        (userData as any).studies?.courses ||
                                        [],
                                },
                            });
                        }
    ...
    const completed_courses = coursesArray.filter(
        (course) => course.isCompleted,
    );
    const current_courses = coursesArray.filter(
        (course) => !course.isCompleted,
    );
            ...
            <VStack space="2xl" className="mt-10">
                ...
                <Card className="bg-up-blue rounded-3xl p-6 space-y-4">
                    <VStack space="md">
                        ...
                        {completed_courses
                            .slice(0, completed_courses_count)
                            .map((course, key) => (
                                <Text
                                    className="text-black bg-up-white rounded-full px-4 py-1 flex-1"
                                    key={key}
                                >
                                    {course.courseName}
                                </Text>
                        ...
                        {completed_courses_count <
                            ...
                            <Button
                                onPress={() =>
                                    setCoursesCount(completed_courses_count + 5)
                                }
